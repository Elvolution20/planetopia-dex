...
export const EXCHANGE_DOCS_URLS = 'https://docs.planetopiaswap.xyz/products/pancakeswap-exchange'
export const EXCHANGE_HELP_URLS = 'https://docs.planetopiaswap.xyz/help'
