...
import { fscTokens, bscTokens, bscTestnetTokens, USDC, USDT, BUSD, WBTC_ETH, PLANET } from '@pancakeswap/tokens'
...
export const ROUTER_ADDRESS: ChainMap<string> = {
  ...
  [ChainId.FSC]: '0xeF02172d48685Cc9Fd2C06b71Bae9cedE4725853',
...
export const BASES_TO_CHECK_TRADES_AGAINST: ChainTokenList = {
  ...
  [ChainId.FSC]: [fscTokens.wfon, fscTokens.planet, fscTokens.usdt],
  [ChainId.BSC]: [
    bscTokens.wbnb,
    bscTokens.cake,
    bscTokens.busd,
...
export const SUGGESTED_BASES: ChainTokenList = {
  ...
  [ChainId.FarmsBaseGoerliPriceHelper]: [],
...
export const LIMIT_ORDERS_DOCS_URL = 'https://docs.planetopiaswap.xyz/products/pancakeswap-exchange/limit-orders'
