export const PANCAKE_EXTENDED = 'https://tokens.planetopiaswap.xyz/pancakeswap-extended.json'
export const COINGECKO = 'https://tokens.planetopiaswap.xyz/coingecko.json'
export const COINGECKO_ETH = 'https://tokens.coingecko.com/uniswap/all.json'
export const CMC = 'https://tokens.planetopiaswap.xyz/cmc.json'
