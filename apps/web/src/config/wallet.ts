  ...
  return [
    {
      ...
      deepLink: 'https://metamask.app.link/dapp/planetopiaswap.xyz/',
      qrCode,
      downloadLink: 'https://metamask.app.link/dapp/planetopiaswap.xyz/',
    },
    // {
    //   id: 'binance',
    ...
    //   deepLink: 'https://link.trustwallet.com/open_url?coin_id=20000714&url=https://planetopiaswap.xyz/',
    //   downloadLink: {
...
export const getDocLink = (code: string) =>
  docLangCodeMapping[code]
    ? `https://docs.planetopiaswap.xyz/v/${docLangCodeMapping[code]}/get-started/wallet-guide`
    : `https://docs.planetopiaswap.xyz/get-started/wallet-guide`
