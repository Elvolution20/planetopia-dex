...
const PoolStatsInfo: React.FC<React.PropsWithChildren<ExpandedFooterProps>> = ({
  ...
  return (
    <>
      ...
      {vaultKey && (
        <Flex mb="2px" justifyContent={alignLinksToRight ? 'flex-end' : 'flex-start'}>
          <LinkExternal href="https://docs.planetopiaswap.xyz/products/syrup-pool/new-cake-pool" bold={false} small>
            {t('View Tutorial')}
          </LinkExternal>
        </Flex>
      )}
      ...
      {account && tokenAddress && (
        <Flex justifyContent={alignLinksToRight ? 'flex-end' : 'flex-start'}>
          <AddToWalletButton
            ...
            tokenLogo={`https://tokens.planetopiaswap.xyz/images/${tokenAddress}.png`}
          />
        </Flex>
      )}
    </>
