...
const config: (t: ContextApi['t']) => ConfigMenuItemsType[] = (t) => [
  {
    ...
    items: [
      ...
      {
        label: t('Bridge'),
        href: 'https://bridge.planetopiaswap.xyz/aptos',
...
export const Menu = ({ children }: { children: ReactNode }) => {
  ...
  return (
    <UIMenu
      ...
      buyCakeLink="https://aptos.planetopiaswap.xyz/swap?outputCurrency=0x159df6b7689437016108a019fd5bef736bac692b6d4a1f10c941f6fbb9a74ca6::oft::CakeOFT"
    >
      {children}
    </UIMenu>
  )
