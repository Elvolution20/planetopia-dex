  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Cheaper and faster than Uniswap? Discover Planetopia, the leading DEX on Base Chain (BASE) with the best farms in DeFi ."
        />
        <meta name="theme-color" content="#fd961a" />
        <meta name="twitter:image" content="https://planetopiaswap.xyz/images/hero.png" />
        <meta
        ...
        <title>Bridge | Planetopia Swap</title>
      </Head>
      <NextThemeProvider>
        <StyledThemeProvider>
          <ModalProvider>
