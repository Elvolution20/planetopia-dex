...
export const lightColors = {
  ...
  textSubtle: '#5b53ae',
  disabled: '#E9EAEB',
  gradientBubblegum: 'linear-gradient(139.73deg, #fff7dc 0%, #F3EFFF 100%)',
  gradientInverseBubblegum: 'linear-gradient(139.73deg, #F3EFFF 0%, #fff7dc 100%)',
...
export const darkColors = {
  ...
  textSubtle: '#B8ADD2',
  disabled: '#524B63',
  gradientBubblegum: 'linear-gradient(139.73deg, #3D2A54 0%, #293249 100%)',
  gradientInverseBubblegum: 'linear-gradient(139.73deg, #293249 0%, #3D2A54 100%)',
